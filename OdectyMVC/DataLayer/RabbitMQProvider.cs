...
public class RabbitMQProvider : IAsyncDisposable
{
    ...
    private async Task Connect()
    {
        ...
        catch (Exception ex)
        {
            ...
            connectionDelay = connectionTimeout = TimeSpan.FromMilliseconds(Math.Min(connectionTimeout.TotalMilliseconds * 2 + RandomNumberGenerator.GetInt32(0, 5000), 300000));
